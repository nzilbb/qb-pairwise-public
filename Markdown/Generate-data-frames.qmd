---
title: "Do 'leaders' sound different from 'laggers? Exploring the perceptual similarity of New Zealand English voices: Data processing for supplementary Materials"
author:   
  - name: Elena Sheard
...
files for the manuscript "Do 'leaders' sound different from 'laggers'?
Exploring the perceptual similarity of New Zealand English voices". The
...
combinations_anon <- read_rds(
  here("Data", "Anonymised", "PW_combinations_anon_250124.rds")
)
```
