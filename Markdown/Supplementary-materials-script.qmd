...
# Generated in 5_matrix generation
...
## Additional functions {#sec-additional-functions}
...
png(
  here("Scripts", "Figures", "D2RegressionTree2.png"),
  #  width = 1950,
  #  height = 1000,
  width = 1400,
  height = 1400,
...
# Unrotated
image_D2 <-
  image_read(here("Scripts", "Figures", "D2RegressionTree2.png")) %>%
  image_annotate(
    "Estimated D2",
    size = 75,
    location = "+575+5",
...
image_write(
  D1_MainD2_appended,
  path = here("Scripts", "Figures", "D1_MainD2_appended.png"),
  format = "png",
  density = 600
)
```
...
the reported model (See @fig-quantiles-prereg, especially the QQ plot).
