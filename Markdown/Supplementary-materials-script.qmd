...
# Density plots with semi-transparent fill
  ...
  ungroup() %>% 
ggplot(aes(y =PairCount,x="Unordered")) +geom_jitter(alpha=0.2) +geom_boxplot(notch = T,alpha=0.85)+
  labs(x="Pairs")+
